...
// ProposalHtmlModal Component
const ProposalHtmlModal: React.FC<{ htmlContent: string; onClose: () => void }> = ({ htmlContent, onClose }) => {
  return (
    <AnimatePresence>
      <motion.div
        initial={{ opacity: 0 }}
...
// AdjacentParcelsTab Component
const AdjacentParcelsTab: React.FC = () => {
  // Mock data for parcels 83-1 to 83-15
  const parcelsData = [
